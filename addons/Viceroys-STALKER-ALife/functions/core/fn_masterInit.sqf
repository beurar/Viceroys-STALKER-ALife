...
VIC_fnc_findLandAGLServer      = compile preprocessFileLineNumbers (_root + "\functions\core\fn_findLandAGLServer.sqf");
...
VIC_fnc_findSite_comet           = compile preprocessFileLineNumbers (_root + "\functions\anomalies\find_sites\fn_findSite_comet.sqf");
...
VIC_fnc_createField_comet       = compile preprocessFileLineNumbers (_root + "\functions\anomalies\fields\fn_createField_comet.sqf");
...
VIC_fnc_findLandASL            = compile preprocessFileLineNumbers (_root + "\functions\core\fn_findLandASL.sqf");
VIC_fnc_findLandAGL            = compile preprocessFileLineNumbers (_root + "\functions\core\fn_findLandAGL.sqf");
