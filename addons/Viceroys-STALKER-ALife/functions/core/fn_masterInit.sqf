...
VIC_fnc_setupMutantHabitats      = compile preprocessFileLineNumbers "functions/mutants/fn_setupMutantHabitats.sqf";
VIC_fnc_hasPlayersNearby         = compile preprocessFileLineNumbers "functions/core/fn_hasPlayersNearby.sqf";
