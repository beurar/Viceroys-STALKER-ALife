/*
    Selects a suitable location for comet anomaly fields.
    Params:
...
["fn_findSite_comet"] call VIC_fnc_debugLog;
...
private _site = [_posCenter, _radius, 10, false] call VIC_fnc_findLandAGL;
