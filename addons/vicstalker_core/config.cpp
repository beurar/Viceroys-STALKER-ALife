...
class Extended_PreInit_EventHandlers
{
    ...
    {
        init = "call compile preprocessFileLineNumbers 'vicstalker_core\functions\core\fn_masterInit.sqf'";
    };
};
...
class Extended_PostInit_EventHandlers
{
    ...
    {
        init = "call compile preprocessFileLineNumbers 'vicstalker_core\initServer.sqf'";
    };
};
