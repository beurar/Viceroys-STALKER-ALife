...
// Defer ALL heavy initialization to prevent game lockup during startup
[] spawn {
    // Initialize map caches - this does expensive grid scans
    // Must happen before spawning systems, but should yield frequently
    [] call VIC_fnc_initMap;
    
    uiSleep 0.5;
    private _center = [worldSize / 2, worldSize / 2, 0];
    
    // Spawn systems with yields between major operations
    uiSleep 0.5;
