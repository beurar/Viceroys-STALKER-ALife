...
private _createMarker = {
    ...
    private _habitatCount = count STALKER_mutantHabitats;
    
    // Early exit if checking too many habitats - performance optimization
    ...
    if (!_overlap && {!isNil "STALKER_anomalyFields"} && {count STALKER_anomalyFields < 500}) then {
        {
